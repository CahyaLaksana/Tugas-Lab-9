...
using tugas_lab9.Objek;

namespace tugas_lab9
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            karyawanTetap.NIK = "6666";
            karyawanTetap.Nama = "Anabelle";
            karyawanTetap.GajiBulanan = 60000000;

            KaryawanHarian karyawanHarian = new KaryawanHarian();
            karyawanHarian.NIK = "9999";
            karyawanHarian.Nama = "Chucky";
        ...
        static void AboutApp()
        {
            ...
            Console.WriteLine("\nNama    : Cahya Laksana");
            Console.WriteLine("NIM      : 19.11.2788");
            Console.WriteLine("Kelas    : 19 IF 03");

            Console.WriteLine("\n* Dibuat dengan Copy Paste Github lewat dibawah!! :)");
